...
class InquiryController extends AbstractActionController
{
    ...
    {
        //endpoint for inquiring shipping info
        ...
        try {
            ...
            $orderMapper->filterByShippingId($shippingId);
            $order = $orderMapper->findByFilter();
            if(empty($order)) {
            ...
            $info = $order->inquireShippingInfo();
            
            //remember to save order (persist to storage)
            $orderMapper->save($order);
            
            $response = $this->_createSuccessResponse($info);
        }
