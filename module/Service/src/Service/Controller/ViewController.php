...
class ViewController extends AbstractActionController
{
    ...
    {
        //endpoint for viewing order detail (all info are shown including shipping info and items details)
        ...
        try {
            ...
            if(false === $order) {
                $response = $this->_createFailedResponse('orderId not found');
                return $response;
            }
            
            //order exists
            $info = $order->getObjectDetail(false);
